...
export interface DepositHandlerInterface extends utils.Interface {
  functions: {
    "_executeDeposit(bytes32,((address,address,address,address,address,address,address,address[],address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256),(bool)),address,uint8)": FunctionFragment;
    ...
    "executeAtomicDeposit(address,(address,address,address,address,address,address,address[],address[],uint256,bool,uint256,uint256),(address[],address[],bytes[]))": FunctionFragment;
