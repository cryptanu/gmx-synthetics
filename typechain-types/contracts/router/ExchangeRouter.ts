...
export interface ExchangeRouterInterface extends utils.Interface {
  functions: {
    ...
    "executeAtomicDeposit((address,address,address,address,address,address,address[],address[],uint256,bool,uint256,uint256),(address[],address[],bytes[]))": FunctionFragment;
    "executeAtomicOrder(((address,address,address,address,address,address,address[]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256),uint8,uint8,bool,bool,bool,bytes32),(address[],address[],bytes[]))": FunctionFragment;
    ...
    "simulateExecuteDeposit(bytes32,(address[],(uint256,uint256)[],uint256,uint256),uint8)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "executeAtomicDeposit",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "executeAtomicOrder",
    values: [
