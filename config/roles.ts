...
// @todo to add/remove roles after deployment, scripts/updateRoles.ts can be used
export default async function (hre: HardhatRuntimeEnvironment): Promise<RolesConfig> {
  ...
  const monadRoles = {
    mainnet: {
      keepers: {
        "0x0aB50Ff78c00C63a319B2aAFde484736E0fc9152": true,
      },
    },
  };
  ...
  const config: {
    ...
    monad: {
      CONTROLLER: { [deployer]: true },
      ADL_KEEPER: monadRoles.mainnet.keepers,
      FROZEN_ORDER_KEEPER: monadRoles.mainnet.keepers,
      LIQUIDATION_KEEPER: monadRoles.mainnet.keepers,
      ORDER_KEEPER: { ...monadRoles.mainnet.keepers },
      LIMITED_CONFIG_KEEPER: monadRoles.mainnet.keepers,
      CONFIG_KEEPER: monadRoles.mainnet.keepers,
      FEE_KEEPER: monadRoles.mainnet.keepers,
      MARKET_KEEPER: monadRoles.mainnet.keepers,
      TIMELOCK_ADMIN: monadRoles.mainnet.keepers,
      // CONTROLLER: {
      //   "0xa8af9b86fc47deade1bc66b12673706615e2b011": true, // OracleStore_1
      //   "0xf5f30b10141e1f63fc11ed772931a8294a591996": true, // MarketFactory_1
